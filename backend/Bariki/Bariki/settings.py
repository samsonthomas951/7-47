"""
Django settings for Bariki project.
...
SECRET_KEY = 'django-insecure-#=zg_(%4y2wj47siur#y1k-act%*z_!d*+*-7gkm7ruzqf1)(7'
...
WSGI_APPLICATION = 'Bariki.wsgi.application'
